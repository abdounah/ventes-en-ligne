    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
           ...
           <div class="navbar-header">
               <a class="navbar-brand" href="${contextRoot}/home">Société RimVente</a>
           </div>
		</div>
	</nav>
		    ...
		    <div class="row">
		        <div class="col-xs-12">
		    		<div class="invoice-title">
		    			<h2>Facture</h2><h3 class="pull-right">Commande # ${orderDetail.id}</h3>
		    		</div>
		    		<hr>
		    		<div class="row">
		    			<div class="col-xs-6">
		    						...
		    						<tbody>
		    							...
		    							<c:forEach items="${orderDetail.orderItems}" var="orderItem">
			    							<tr>
			    								...
			    								<td class="text-center"> ${orderItem.buyingPrice} - UM</td>
			    								<td class="text-center">${orderItem.productCount}</td>
			    								<td class="text-right"> ${orderItem.total} UM</td>
			    							</tr>
		    							</c:forEach>
		    						</tbody>
		    					</table>
