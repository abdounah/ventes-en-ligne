			...
			<table id="cart" class="table table-hover table-condensed">
			   	<thead>
					<tr>
						...
						<th style="width:22%" class="text-center">Total partiel</th>
				...
				<tbody>
					...
					<tr>
						...
						<td data-th="Price"> ${cartLine.buyingPrice} - UM</td>
						<td data-th="Quantity">
							<input type="number" id="count_${cartLine.id}" class="form-control text-center" value="${cartLine.productCount}" min="1" max="${cartLine.product.quantity}">
						</td>
						<td data-th="Subtotal" class="text-center"> ${cartLine.total} - UM</td>
				...
				<tfoot>
					<tr class="visible-xs">
						<td class="text-center"><strong>Total  ${userModel.cart.grandTotal} UM</strong></td>
					</tr>
					<tr>
						...
						<td class="hidden-xs text-center"><strong>Total  ${userModel.cart.grandTotal} - UM</strong></td>
