		...
		<div class="col-md-9">
			...
			<div class="row carousel-holder">
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            ...
                            <h5>{{product.name}} - {{product.unitPrice}} UM</h5>
                            <hr/>
                            <div class="caption">
                                
                                <p>{{product.description}}</p>
                                <a ng-href="${contextRoot}/show/{{product.id}}/product" class="btn btn-primary pull-right">Voir</a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <h4>Consultez plus de produits !</h4>
                        <hr/>
               ...
               <div class="row is-table-row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <h4>Découvrez davantage de produits !</h4>
                        <hr/>
                        <a class="btn btn-primary" href="${contextRoot}/show/all/products">Plus de produits</a>
                    </div>
