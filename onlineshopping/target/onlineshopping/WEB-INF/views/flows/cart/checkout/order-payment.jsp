	...
	<div class="row">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div>
							...
							<h5>Buying Price - ${cartLine.buyingPrice} - UM</h5>							
						</div>						
						<hr/>
						<div class="text-right">
							<h3>Grand Total - ${cartLine.total} - UM</h3>
						</div>						
					</div>
					</c:forEach>
				</div>
			...
			<div class="col-md-6">
	            ...
	            <ul class="nav nav-pills nav-stacked">
	                <li class="active"><a href="#"><span class="badge pull-right"> ${checkoutModel.checkoutTotal} - UM</span> Paiement final</a></li>
	            </ul>
	            <br/>
